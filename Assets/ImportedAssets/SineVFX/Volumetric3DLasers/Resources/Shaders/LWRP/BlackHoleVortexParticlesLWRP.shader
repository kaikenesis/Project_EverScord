	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 panner14 = ( 1.0 * _Time.y * float2( 0,0.05 ) + ( uv_Noise01 + IN.ase_texcoord4.z ));
				float2 uv_Mask01 = IN.ase_texcoord4.xy * _Mask01_ST.xy + _Mask01_ST.zw;
				float2 appendResult15 = (float2(uv_Mask01.x , ( uv_Mask01.y + (-1.0 + (IN.ase_color.a - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) )));
				float clampResult26 = clamp( ( tex2D( _Noise01, panner14 ).r * tex2D( _Mask01, appendResult15 ).r ) , 0.0 , 1.0 );
				float2 uv_Mask02 = IN.ase_texcoord4.xy * _Mask02_ST.xy + _Mask02_ST.zw;
				...
				float2 uv_Noise02 = IN.ase_texcoord4.xy * _Noise02_ST.xy + _Noise02_ST.zw;
				float2 panner21 = ( 1.0 * _Time.y * float2( 0,0.25 ) + ( uv_Noise02 + IN.ase_texcoord4.z ));
				float temp_output_25_0 = ( clampResult26 * tex2D( _Mask02, uv_Mask02 ).r * ( 1.0 - fresnelNode23 ) * tex2D( _Noise02, panner21 ).r * _MaskPower );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 panner14 = ( 1.0 * _Time.y * float2( 0,0.05 ) + ( uv_Noise01 + IN.ase_texcoord3.z ));
				float2 uv_Mask01 = IN.ase_texcoord3.xy * _Mask01_ST.xy + _Mask01_ST.zw;
				float2 appendResult15 = (float2(uv_Mask01.x , ( uv_Mask01.y + (-1.0 + (IN.ase_color.a - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) )));
				float clampResult26 = clamp( ( tex2D( _Noise01, panner14 ).r * tex2D( _Mask01, appendResult15 ).r ) , 0.0 , 1.0 );
				float2 uv_Mask02 = IN.ase_texcoord3.xy * _Mask02_ST.xy + _Mask02_ST.zw;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				...
				float2 panner21 = ( 1.0 * _Time.y * float2( 0,0.25 ) + ( uv_Noise02 + IN.ase_texcoord3.z ));
				float temp_output_25_0 = ( clampResult26 * tex2D( _Mask02, uv_Mask02 ).r * ( 1.0 - fresnelNode23 ) * tex2D( _Noise02, panner21 ).r * _MaskPower );
				float clampResult28 = clamp( temp_output_25_0 , 0.0 , 1.0 );
				float Opacity29 = clampResult28;
...
Node;AmplifyShaderEditor.SamplerNode;10;-1887.866,-477.8262;Inherit;True;Property;_Noise01;Noise 01;4;0;Create;True;0;0;0;False;0;False;-1;None;257e43786c09482ebde4c6ee7ff0e59c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;11;-1888.866,-284.8262;Inherit;True;Property;_Mask01;Mask 01;2;0;Create;True;0;0;0;False;0;False;-1;None;f9efb96faef946aaa9e1c7db321dd8bd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;17;-1484.741,355.5477;Inherit;True;Property;_Noise02;Noise 02;5;0;Create;True;0;0;0;False;0;False;-1;None;9be45b213b6b40b68fb0be88918732d0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;18;-1479.318,-51.3884;Inherit;True;Property;_Mask02;Mask 02;3;0;Create;True;0;0;0;False;0;False;-1;None;498459b524f740f798b866fb3164079b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.OneMinusNode;24;-1350.227,160.322;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-1466.503,553.9565;Float;False;Property;_MaskPower;Mask Power;6;0;Create;True;0;0;0;False;0;False;0;4;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-862.6699,335.4508;Float;False;Property;_FinalPower;Final Power;1;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;34;-329.5218,351.1709;Inherit;False;29;Opacity;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;32;-774.9038,483.4744;Float;False;Property;_FinalColor;Final Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0.462745,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=93A56D879431E8378851A08D26280AB890448129